...
it(`Error message verification: "password not provided" -Es `, async () => {
...
it(`Error message verification: "short password" -Es`, async () => {
  await SpanishLanguage.enterEmail("nag.subbarayudu@thinkhat.ai");
